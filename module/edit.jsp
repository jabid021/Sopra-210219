	...
	<div class="container">
		<form:form action="${ctx}/module/save" method="post"
			...
			<div class="form-group">
				...
				<form:errors path="details" cssClass="alert alert-danger" element="div"></form:errors>
			</div>
			
			<div class="form-group">
				<form:label path="duree">duree:</form:label>
				<form:input path="duree" cssClass="form-control" />
				<form:errors path="duree" cssClass="alert alert-danger" element="div"></form:errors>
			</div>
