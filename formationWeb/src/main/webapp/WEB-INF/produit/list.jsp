		...
		<table class="table">
			...
			<c:forEach items="${produits}" var="p">
				<tr>
					...
					<td><a href="?query=edit&id=${p.id}"
						class="btn btn-outline-primary">editer</a></td>
					<td><a href="?query=delete&id=${p.id}"
						class="btn btn-outline-danger">supprimer</td>
				</tr>
			</c:forEach>
		</table>
		<a href="?query=add" class="btn btn-link">ajouter un produit</a>
	</div>
</body>
</html>